...
void CArcBall::Place(std::vector<float> center, double radius)
{
	ball_data.center.x = center.at(0);
	ball_data.center.y = center.at(1);
	ball_data.center.z = center.at(2);
	ball_data.center.w = 1;
	ball_data.radius = radius;
}
