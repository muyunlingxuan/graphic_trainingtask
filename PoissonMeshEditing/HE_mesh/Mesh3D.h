...
public: 
	...
	void		insert_normal(const Vec3f& n) {normal_=n;}
	void		insert_position(const Vec3f& p) {position_=p;}
	void		insert_id(int id) {id_=id;}
	void		insert_color(const Vec4f& c) {color_=c;}
	void		insert_seleted(int tag){selected_=tag;}
	void		insert_boundary_flag(BoundaryTag bt) {boundary_flag_=bt;}
};
...
public:
	...
	void			insert_selected(int tag){selected_=tag;}
	void			insert_color(const Vec4f& c) {color_=c;}
	void			insert_boundary_flag(BoundaryTag bt) {boundary_flag_=bt;}
