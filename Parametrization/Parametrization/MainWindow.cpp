...
void MainWindow::CreateActions()
{
	...
	action_param2_ = new QAction(tr("param2"), this);
	action_param3_ = new QAction(tr("param3"), this);
	action_miniSurf_ = new QAction(tr("miniSurf"), this);
	action_miniSurf2_ = new QAction(tr("miniSurf2"), this);
	...
	connect(action_miniSurf_, SIGNAL(triggered()), renderingwidget_, SLOT(MiniSurf1()));
	connect(action_miniSurf2_, SIGNAL(triggered()), renderingwidget_, SLOT(MiniSurf2()));
	connect(action_param_, SIGNAL(triggered()), renderingwidget_, SLOT(Parameterize1()));
	connect(action_param2_, SIGNAL(triggered()), renderingwidget_, SLOT(Parameterize2()));
	connect(action_param3_, SIGNAL(triggered()), renderingwidget_, SLOT(Parameterize3()));
}
...
void MainWindow::CreateToolBars()
{
	...
	toolbar_basic_->addAction(action_miniSurf_);
	toolbar_basic_->addAction(action_miniSurf2_);
	toolbar_basic_->addAction(action_param_);
	toolbar_basic_->addAction(action_param2_);
	toolbar_basic_->addAction(action_param3_);
}
